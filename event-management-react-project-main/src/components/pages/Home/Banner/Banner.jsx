    ...
    <div className="md:max-h-screen  mx-auto  lg:h-[800px] ">
      ...
      >
        <div className="text-center">
          <p className=" text-2xl lg:text-6xl md:mb-5">The Biggest Event of The Year</p>
          <h2 className="md:text-xl">Coming Soon. . .</h2>
        </div>
        ...
        <div className="lg:p-10 p-5 flex items-center justify-center mx-auto lg:gap-10 lg:max-w-lg rounded-2xl bg-orange-600 bg-opacity-10 ">
          <div className="text-center text-white">
            <h3 className="lg:text-2xl md:mb-5">December 13, 2024</h3>
            <p className="text-sm lg:text-xl">
              MDC,Punjab,India and Online
            </p>
          </div>
