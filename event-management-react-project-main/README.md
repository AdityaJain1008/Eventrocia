...
## [ Live Website Link](https://eventrocia-auth.web.app/)

Also Click here : [https://eventrocia-auth.web.app/](https://eventrocia-auth.web.app/)

## New Feature: THREE.js View in Event Details Page and firestore impliment - 13-12-2024
...
- This website is event management related.
...
Welcome to the Event Management Website! This project is designed to help you manage and organize events seamlessly. The website is built using React, Material Tailwind, Firebase for authentication and hosting, React Toasty for notifications, Tailwind CSS, and Vite for efficient development.
